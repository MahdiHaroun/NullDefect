...
# From the original PatchCore paper (Roth et al., 2022) on MVTec AD.
# Used in Phase 3 evaluation to compare your results against published numbers.

PATCHCORE_BENCHMARKS = {
    "bottle":      {"image_auroc": 0.9996},
    "cable":       {"image_auroc": 0.9938},
    "capsule":     {"image_auroc": 0.9820},
    "carpet":      {"image_auroc": 0.9870},
    "grid":        {"image_auroc": 0.9827},
    "hazelnut":    {"image_auroc": 1.0000},
    "leather":     {"image_auroc": 1.0000},
    "metal_nut":   {"image_auroc": 1.0000},
    "pill":        {"image_auroc": 0.9661},
    "screw":       {"image_auroc": 0.9750},
    "tile":        {"image_auroc": 0.9874},
    "toothbrush":  {"image_auroc": 1.0000},
    "transistor":  {"image_auroc": 1.0000},
    "wood":        {"image_auroc": 0.9891},
    "zipper":      {"image_auroc": 0.9985},
    "mean":        {"image_auroc": 0.9910},
}